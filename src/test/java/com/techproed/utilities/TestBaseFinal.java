...
public abstract class TestBaseFinal {
    ...
    //Test islemine baslamadan hemen önce.Tüm test isleminden önce
    @BeforeTest(alwaysRun = true)//always run . Her zaman calisir.
    public void setUpTest() {//This is how to set up Extent report. We will create and use this one in out test classes
        ...
        //Rapor olusturduktan sonra raporunuz nereye eklensin buraya yaz.
        ...
        //Olusturmak istediginiz raporu (html formatinda) baslatiyoruz,filePath ile dosya yolunu belirliyoruz.)
        ...
        //Istedigimiz bilgileri buraya ekleyebilyorsunuz.
    ...
    public void tearDownMethod(ITestResult result) throws IOException {
        if (result.getStatus() == ITestResult.FAILURE) {//Basarisizsa When test case fails, then take the screenshot and attached the report
        ...
        } else if (result.getStatus() == ITestResult.SKIP) {//Test calistirilmadiysa pass gectiniz atladiniz
            extentTest.skip("Test Case is skipped: " + result.getName());//ignore olanlar
        }
        Driver.closeDriver();
    }
    //Raporlandirmayi sonlandiriyorduk
